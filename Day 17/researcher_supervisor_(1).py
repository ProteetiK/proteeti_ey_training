...
Original file is located at
    https://colab.research.google.com/drive/1NibvU_QEQMnXONJXTdyCciwDUsmbCI8E
"""
...
TAVILY_API_KEY = userdata.get('TAVILY_API_KEY') # Retrieve Tavily API Key
...
search_tool = TavilySearchResults(k=2, tavily_api_key=TAVILY_API_KEY) # Pass the Tavily API Key
