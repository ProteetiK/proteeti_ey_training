...
Original file is located at
    https://colab.research.google.com/drive/1EedpHB4C97IyfBjmxgT8nLpnz5RXl5IV
...
def equalised_odds(df, group_col, outcome_col='rejected'):
    ...
    true_creditworthy = 1:
        credit_score >= 650 AND income >= 40000

    FPR = Rejecting someone who IS creditworthy
    TPR = Rejecting someone who is NOT creditworthy
    """
    ...
    for group, gdf in df.groupby(group_col):
        ...
        # Actually not creditworthy
        unworthy = gdf[gdf['true_creditworthy'] == 0]

        # False Positive Rate:
        # rejected despite deserving approval
        fpr = (
