# -*- coding: utf-8 -*-
"""colab2_feedback_loop (1).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Rtjkm6bhXJxGj7ReA7sTiSaQM-0LtNla
...
for i, borrower_data in enumerate(tqdm(BORROWER_PROFILES[:SIMULATE_N], desc='v2.0')):
    ...
    # Prepare a dictionary for categorise_failure
    cat_input_data = {
    ...
    cat = categorise_failure(cat_input_data)
...
!pip install -q langsmith langchain-groq
...
client.create_project(
    "finsight-feedback-loop",
    upsert=True
)

print("✓ LangSmith project ready")
...
def call_with_tracing(prompt_cfg, borrower_data):
    ...
    client.create_run(
        id=run_id,
        name="credit_memo_groq",
        run_type="chain",
        inputs={
            "borrower_data": borrower_data,
            "prompt_version": "PROMPT_V2_0"
        },
        project_name="finsight-feedback-loop"
    )
...
print("Project: finsight-feedback-loop")
