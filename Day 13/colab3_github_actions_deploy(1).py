...
Original file is located at
    https://colab.research.google.com/drive/1VLgaO_hmtuU4YOcqyit1oTYvdtQpJJsx
...
def git(cmd, cwd=REPO_DIR):
    r = subprocess.run(
        shlex.split(cmd),   # preserves quoted strings
        cwd=str(cwd),
        capture_output=True,
        text=True
    )
...
#Option 1:
workflow_path = REPO_DIR / ".github" / "workflows" / "llm-eval.yml"
...
print("Slack notification added")
...
subprocess.run(["git","commit","-m","Add Slack notification"], cwd=REPO_DIR)
